...
stft = TacotronSTFT(hparams.filter_length, hparams.hop_length, hparams.win_length,
                    ...
                    hparams.mel_fmax)
speaker = "nes"
checkpoint_path = './checkpoint/checkpoint_180000' #'/mnt/sdd1/backup_149/checkpoints/supervised/checkpoint_180000'
model = initiate_model(hparams).cuda().eval()
model.load_state_dict(torch.load(checkpoint_path)['state_dict'])
waveglow_path = './checkpoint/waveglow_256channels_v4.pt' #'/home/admin/projects/mellotron_init_with_single/models/waveglow_256channels_v4.pt'
waveglow = torch.load(waveglow_path)['model'].cuda().eval()
denoiser = Denoiser(waveglow).cuda().eval()
arpabet_dict = cmudict.CMUDict('data/cmu_dictionary')
test_text_path = '/content/drive/MyDrive/emotion-tts/emotion_tts/filelists/emotion/text0820.txt' #'filelists/emotion/emotion_test_grapheme.txt'
...
for i, batch in enumerate(dataloader):
    ...
    with torch.no_grad():
        ...
        for j in range(len(audio)):
            ...
            path="./testout/sample-{:03d}_target_speaker-{}_referende_speaker-{}-180000.wav".format(i*hparams.batch_size+j, speaker, reference_speaker)
